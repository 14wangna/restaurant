...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua/index.php/Admin/Indexen/index">Home</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/shanghua/index.php/Admin/Joben/listsen">Position management</a><span class="crumb-step">&gt;</span><span>Add position</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shanghua/index.php/Admin/Joben/doEditen" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr><td>
                                <input type="hidden" name="id" value="<?php echo ($joben["id"]); ?>">
                            </td></tr>
                            <tr>
                                <th>Position：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="<?php echo ($joben["title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>Release time：</th>
                            ...
                            <tr>
                                <th>Work place：</th>
                                <td>
                                    <input class="common-text required" id="title" name="place" size="50" value="<?php echo ($joben["place"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>Recruitment number：</th>
                                <td>
                                    <input class="common-text required" id="title" name="num" size="50" value="<?php echo ($joben["num"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>Job content：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($joben["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th>Job requirements：</th>
                                <td><textarea name="demand" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($joben["demand"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
