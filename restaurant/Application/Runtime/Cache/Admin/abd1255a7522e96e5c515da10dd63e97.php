...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/restaurant/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">资讯列表</span></div>
        </div>
        <div class="result-wrap">
            <form name="myform" id="myform" action="/restaurant/index.php/Admin/Industry/delete">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/restaurant/index.php/Admin/Industry/add"><i class="icon-font"></i>新增资讯</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($industry)): $i = 0; $__LIST__ = $industry;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="checkbox" name="industryId[]" id="checkbox" value="<?php echo ($data["id"]); ?>"><label for="checkbox"></label></td>
                            <td><img src="/restaurant/Public/<?php echo ($data["thumb"]); ?>" width="60px" height="60px"></td>
                            <td><?php echo (msubstr($data["title"],0,8,'utf-8',ture)); ?></td>
                            <td><?php echo (msubstr($data["content"],0,8,'utf-8',ture)); ?></td>
                            <td><?php echo ($data["time"]); ?></td>
                            <td>
                                <a class="link-update" href="/restaurant/index.php/Admin/Industry/edit/id/<?php echo ($data["id"]); ?>">修改</a>
                                <a class="link-del" href="/restaurant/index.php/Admin/Industry/delete/industryId/<?php echo ($data["id"]); ?>">删除</a>
                            </td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                    <div id="alldelete">

                    <button type="submit" id="batchDel" class="btn btn-danger " href="/restaurant/index.php/Admin/Industry/delete">批量删除</button> 
                     </div>
