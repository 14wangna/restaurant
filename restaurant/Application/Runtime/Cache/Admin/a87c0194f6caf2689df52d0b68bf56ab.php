...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/restaurant/restaurant/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/restaurant/restaurant/index.php/Admin/Food/lists?p=1">菜品管理</a><span class="crumb-step">&gt;</span><span>新增菜品</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="price" name="price" size="50" value="" type="text"><i class="info2" style="color:red;">价格不能为空</i>
                                </td>
                            </tr>
                            <tr>
