    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shanghua/index.php/Admin/Honoren/doEditen" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr><td>
                                <input type="hidden" name="id" value="<?php echo ($honoren["id"]); ?>">
                            </td></tr>
                            <tr>
                                <th>Certificate of honor：</th>
                                <td>
                                <img src="/shanghua/Public/<?php echo ($honoren["thumb"]); ?>" width="60px" height="60px">
                                <input name="thumb" id="" type="file"></td>
                            </tr>
                            
                            <tr>
                                <th>Honor description：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($honoren["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
