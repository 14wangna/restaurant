...
<div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/restaurant/restaurant/index.php/Admin/Admin/delete">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/restaurant/restaurant/index.php/Admin/Admin/add"><i class="icon-font">&#xe026;</i>添加管理员</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/restaurant/restaurant/index.php/Admin/Admin/manage/data/<?php echo ($data["id"]); ?>">修改</a>
                                <a class="link-del" href="/restaurant/restaurant/index.php/Admin/Admin/delete/usersId/<?php echo ($data["id"]); ?>">删除</a>
                            </td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                    <div id="alldelete">

                    <button type="submit" id="batchDel" class="btn btn-danger " href="/restaurant/restaurant/index.php/Admin/Admin/delete">批量删除</button> 
                     </div>
