                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select  class="common-text required" value="<?php echo ($news["type"]); ?>" style="width:200px">
                                        <?php if(is_array($newstypes)): $i = 0; $__LIST__ = $newstypes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i; if($news["type"] == $newstype.type): ?><option value="<?php echo ($data["type"]); ?>" selected><?php echo ($data["type"]); ?></option>
                <?php else: ?>
