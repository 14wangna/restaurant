...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua/index.php/Admin/Indexen/index">Home page</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/shanghua/index.php/Admin/Caseen/listsen">Case management</a><span class="crumb-step">&gt;</span><span>Add case</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shanghua/index.php/Admin/Caseen/doEditen" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr><td>
                                <input type="hidden" name="id" value="<?php echo ($caseen["id"]); ?>">
                            </td></tr>
                            <tr>
                                <th>TITLE</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="title" size="50" value="<?php echo ($caseen["title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>Case picture</th>
                                <td>
                                <img src="/shanghua/Public/<?php echo ($caseen["thumb"]); ?>" width="60px" height="60px">
                                <input name="thumb" id="" type="file"><!--<input type="submit" onclick="submitForm('/jscss/admin/design/upload')" value="上传图片"/>--></td>
                            </tr>
                            
                            <tr>
                                <th>Content</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($caseen["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
