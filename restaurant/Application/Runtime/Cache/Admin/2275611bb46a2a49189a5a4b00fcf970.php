...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/restaurant/restaurant/Public/admin/css/login.css"/>
    <script type="text/javascript" src="/restaurant/restaurant/Public/admin/js/modernizr.min.js"></script>
    <script type="text/javascript" src="/restaurant/restaurant/Public/admin/js/login.js"></script>
</head>
    	...
    	<div class="topbar-inner clearfix">
	        ...
	        <div class="top-info-wrap">
	            <ul class="top-info-list clearfix">
	                <li><a href="/restaurant/restaurant/index.php/Admin/Index/index" class="top-a">后台首页</a></li>
