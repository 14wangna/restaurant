...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua/index.php/Admin/Indexen/indexen">Home page</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/shanghua/index.php/Admin/Newen/listsen">News management</a><span class="crumb-step">&gt;</span><span>Modify news</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shanghua/index.php/Admin/Newen/doEditen" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                             <tr><td>
                                <input type="hidden" name="id" value="<?php echo ($newsen["id"]); ?>">
                            </td></tr>
                            <tr>
                                <th><i class="require-red">*</i>Title：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="<?php echo ($newsen["title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>News pictures:</th>
                                <td>
                                <img src="/shanghua/Public/<?php echo ($newsen["thumb"]); ?>" width="60px" height="60px">
                            ...
                            <tr>
                                <th>Content:</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($newsen["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
