...
<body>
  ...
  <div id="nav-header">
    ...
    <div id="nav-right">
      <p><a href="<?php echo U('Honor/wenhua');?>">中文&nbsp;</a>|<a href="<?php echo U('Honor/wenhuae');?>">&nbsp;English</a></p>
    </div>
     
  </div>
  <div id="nav-banner">
    <img src="/shanghua/Public/home/images/wenhua.jpg">
  </div>
  <div id="bread">
    <div id="bread-left">Company Culture</div>
      <div id="bread-right"><a href="<?php echo U('Index/indexe');?>">Home&nbsp;</a>>><a href="<?php echo U('Honor/jianjiee');?>">&nbsp;About Shanghua&nbsp;</a>>>&nbsp;Company Culture</div>
  </div>
     <div>
      <div class="container">
          ...
          <div class="col-md-4">
            ...
            <hr style="border:none;border-top:2px ridge orange;width:40px;margin-top:5px;position:absolute;" /><br/>
              <ul class="p0 category_item met_aside_list ecopc">
                ...
                <li><a href="<?php echo U('Honor/jianjiee');?>" title="公司简介" target='_self'><i class="fa fa-angle-right"></i><em class="em2"></em>&nbsp;&nbsp;Company Profile</a> 
             
                </li>

                <li><a href="<?php echo U('Honor/wenhuae');?>" class='active'  title="公司文化" target='_self'><i class="fa fa-angle-right"></i><em class="em1"></em>&nbsp;&nbsp;Company Culture</a> 
          ...
          <div class="col-md-7 shop-page-content">
            ...
            <div class="img">
              <img src="/shanghua/Public/home/images/wenhua1.jpg">
            </div>
          </div>
