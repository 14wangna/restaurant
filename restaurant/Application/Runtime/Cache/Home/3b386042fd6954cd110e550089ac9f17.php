	...
	<div class="page-theme">
		...
		<div class="page-content">
			<div class="page-left">
				...
				<form action="/restaurant/restaurant/index.php/Home/Person/dopwd" method="POST" id="myform" name="myform" enctype="multipart/form-data">
				<div class="left-mes">
					<div class="mes-img">
					...
					<div class="person-items">
				 		<a class="link-update" href="/restaurant/restaurant/index.php/Home/Person/pass/id/<?php echo ($user["id"]); ?>">修改个人密码</a>
				 	</div>
				</div>
				</form>
