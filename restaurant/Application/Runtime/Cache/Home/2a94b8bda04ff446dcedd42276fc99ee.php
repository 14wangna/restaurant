	...
	<!--主体部分 开始-->
		...
		<div class="page-theme-banner">
			<div class="page-theme-banner-left">
				<ul>
					<li><a href="/restaurant1/restaurant/index.php/Home/menu/menu" class="la">早餐</a>
						<ul>
					...
					<li><a href="/restaurant1/restaurant/index.php/Home/menu/menu" class="la">午餐</a>
						<ul>
					...
					<li><a href="/restaurant1/restaurant/index.php/Home/menu/menu" class="la">下午茶</a>
						<ul>
					...
					<li><a href="/restaurant1/restaurant/index.php/Home/menu/menu" class="la">晚餐</a>
						<ul>
					...
					<li><a href="/restaurant1/restaurant/index.php/Home/menu/menu" class="la">甜品饮品</a>
						<ul>
					...
					<li><a href="/restaurant1/restaurant/index.php/Home/menu/menu" class="la">小吃夜宵</a>
						<ul>
		...
		<div class="page-news">
			<div class="page-news-item">
				...
				<div class="w-3">
					<ul>
						<?php if(is_array($newsa)): $i = 0; $__LIST__ = array_slice($newsa,3,6,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a href="/restaurant1/restaurant/index.php/Home/News/content/id/<?php echo ($data["id"]); ?>"><?php echo ($data["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
				</div>
			</div>
			...
			<div class="page-news-item">
				...
				<div class="w-3">
					<ul>
						<?php if(is_array($newsc)): $i = 0; $__LIST__ = $newsc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a href="/restaurant1/restaurant/index.php/Home/News/content/id/<?php echo ($data["id"]); ?>"><?php echo ($data["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
				</div>
			</div>
			<div class="clear"></div>
