...
<body>
	...
	<div class="page-theme">
					...
					<li><a href="javascript: void (0);" class="la">早餐</a>
						<ul>
							...
							<li><a href="javascript:void(0)">
								<img src="/restaurant/Public/home/images/mamapai.jpg">
							</a></li>
							...
							<div class="carousel slide" id="carousel-912679">
								...
								<div class="carousel-inner">
									<div class="item active">
										<img alt="" src="/restaurant/Public/home/images/banner1.jpg" />
										<div class="carousel-caption">
											
										</div>
									</div>
									<div class="item">
										<img alt="" src="/restaurant/Public/home/images/banner2.jpg" />
										<div class="carousel-caption">
											
										</div>
									</div>
									<div class="item">
										<img alt="" src="/restaurant/Public/home/images/banner3.jpg" />
										<div class="carousel-caption">
		...
		<div class="page-news">
			<div class="page-news-item">
				...
				<div class="w-2">
					<img src="/restaurant/Public/home/images/w-1.jpg" width="100%" height="124px">
				</div>
				<div class="w-3">
					<ul>
		...
		<div class="page-menu">
			...
			<div class="page-menu-food">
				<ul>
					<li>
						<a href="javascript:void(0)">
							<img src="/restaurant/Public/home/images/1.jpg" width="100%" height="100%">
						</a>
						<p>麻蓉包</p>
	...
	<div class="back-top" onclick="back()">
		<a><img src="/restaurant/Public/home/images/back.png"></a>
	</div>
	<!-- 页脚 -->
	<div class="footers">
		<div class="footer">
